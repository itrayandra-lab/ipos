    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('sales/manage-master/products') }}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('sales/manage-master/products/update') }}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('sales/manage-master/products/all') }}",
                    type: "GET"
                },
                columns: [
            ...
            $('.table').on('click', '.edit[data-id]', function(e) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ url('sales/manage-master/products/get') }}",
                    beforeSend: function() {
                        $.LoadingOverlay("show", {
                            image: "",
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            type: 'DELETE',
                            url: "{{ url('sales/manage-master/products') }}",
                            beforeSend: function() {
                                $.LoadingOverlay("show", {
                                    image: "",
                                    fontawesome: "fa fa-cog fa-spin"
