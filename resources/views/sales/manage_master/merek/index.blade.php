    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('sales/manage-master/merek') }}" method="POST" class="needs-validation" novalidate="">
                    @csrf
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ url('sales/manage-master/merek/update') }}" method="POST" class="needs-validation" novalidate="">
                    @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('sales/manage-master/merek/all') }}",
                    type: "GET"
                },
                columns: [
            ...
            $('.table').on('click', '.edit[data-id]', function(e) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{ url('sales/manage-master/merek/get') }}",
                    beforeSend: function() {
                        $.LoadingOverlay("show", {
                            image: "",
                ...
                swal({
                    ...
                    if (willDelete) {
                        $.ajax({
                            ...
                            type: 'DELETE',
                            url: "{{ url('sales/manage-master/merek') }}",
                            beforeSend: function() {
                                $.LoadingOverlay("show", {
                                    image: "",
                                    fontawesome: "fa fa-cog fa-spin"
