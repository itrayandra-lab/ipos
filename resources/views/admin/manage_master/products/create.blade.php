    ...
    <div class="main-content">
        ...
        <section class="section">
            ...
            <div class="section-body">
                <form id="form-add-product" action="{{ url('admin/manage-master/products') }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="premium-card animate-fade-up mb-4">
                                ...
                                <div class="card-body p-4">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Masukkan Nama Lengkap Produk"
                                                    class="form-control-premium w-100" name="name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label><i class="fas fa-barcode mr-1"></i> Kode Produk / Ref <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" placeholder="Contoh: CRM"
                                                    class="form-control-premium w-100" name="code" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><i class="fas fa-copyright mr-1"></i> Merk <span
                                                        class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label><i class="fas fa-shapes mr-1"></i> Tipe Produk <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-control select2" name="product_type_id"
                                                    id="add-product-type" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" placeholder="0" class="form-control-premium w-100"
                                                    name="min_stock_alert" required min="0" value="0">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group mb-0 mt-2">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" name="is_bundle"
                                                id="is_bundle_add" value="1">
                                            <label class="custom-control-label font-weight-bold text-primary"
                                                for="is_bundle_add" style="cursor: pointer;">Produk ini adalah Paket /
                                                Bundling</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Bundle Items -->
                            <div class="premium-card animate-fade-up mb-4" id="bundle-items-section-add"
                                style="display: none;">
                                <div class="card-header-premium">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table table-hover mb-0 variant-table" id="table-variants">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <input type="text" name="variants[0][netto]"
                                                            class="form-control-premium w-100" placeholder="100" required>
                                                    </td>
                                                    <td>
                                                        <select name="variants[0][satuan]"
                                                    ...
                                                    <td>
                                                        <input type="text" name="variants[0][sku]"
                                                            class="form-control-premium w-100 bg-white font-weight-bold text-primary"
                                                            placeholder="SKU" required style="letter-spacing: 0.5px;">
                                                    </td>
                                                    <td>
                                                        <div class="input-group-premium">
                                                            ...
                                                            <input type="hidden" name="variants[0][price]"
                                                                class="raw-price-variant">
                                                        </div>
                                                    </td>
                                    ...
                                    <div class="p-3 bg-light border-top">
                                        <small class="text-muted">
                                            <i class="fas fa-magic mr-1 text-primary"></i> SKU digenerate otomatis:
                                            <strong>Merk-Kategori-Kode-Netto</strong>. Klik SKU untuk mengedit manual.
                                        </small>
                                    </div>
                                </div>
                            </div>
