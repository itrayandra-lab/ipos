                            ...
                            <div class="premium-card animate-fade-up mb-4">
                                ...
                                <div class="card-body p-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label><i class="fas fa-barcode mr-1"></i> Kode Produk / Ref <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><i class="fas fa-copyright mr-1"></i> Merk <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label><i class="fas fa-shapes mr-1"></i> Tipe Produk <span class="text-danger">*</span></label>
