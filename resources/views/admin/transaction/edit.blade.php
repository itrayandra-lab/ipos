...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form action="{{ route('admin.transactions.update', $transaction->id) }}" method="POST" id="transaction-form">
                @csrf
                @method('PUT')
                ...
                <div class="mb-5 text-right">
                    <a href="{{ route('admin.transactions.index') }}" class="btn btn-secondary btn-lg px-5">
