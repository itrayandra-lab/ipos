                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="transaction_date" class="form-control form-control-premium" value="{{ old('transaction_date', date('Y-m-d')) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="premium-card">
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-muted font-weight-bold">Biaya Lain</span>
                                    <div>
                                        <span id="label-other-fees" class="text-success font-weight-bold mr-2">Rp 0</span>
...
<script>
    ...
    function recalc() {
        ...
        const grandTotal = Math.max(0, total - discount + otherFeesTotal);
