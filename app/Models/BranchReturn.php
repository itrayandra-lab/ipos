...
class BranchReturn extends Model
{
    use HasFactory;
    ...
    {
        return $this->hasMany(BranchReturnItem::class, 'branch_return_id');
    }
    ...
    public function getStatusLabelAttribute(): string
    {
        return match ($this->status) {
            ...
            'received'  => '<span class="badge badge-success">Diterima Pusat</span>',
