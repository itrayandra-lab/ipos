    ...
    public function getall()
    {
        ...
        return DataTables::of($requests)
            ...
            ->addColumn('action', function ($r) {
                ...
                $btn = '<a href="' . route('branch.stock_requests.show', $r->id) . '" class="btn btn-sm btn-info" title="Detail"><i class="fas fa-eye"></i></a>';
                if ($canReview) {
                    $btn .= ' <a href="' . route('admin.branch.stock_requests.show', $r->id) . '" class="btn btn-sm btn-warning" title="Review"><i class="fas fa-check"></i> Review</a>';
                }
                return $btn;
            })
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $stockRequest = BranchStockRequest::create([
                'reference_number'   => BranchStockRequest::generateReferenceNumber(),
